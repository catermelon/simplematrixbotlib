...
from simplematrixbotlib_old.creds import CredsError
...
class Bot:
    ...
    api : simplematrixbotlib.Api
        An instance of the simplematrixbotlib_old.Api class.
    
    """

    def __init__(self):
        """
        Initializes the simplematrixbotlib_old.Bot class.
